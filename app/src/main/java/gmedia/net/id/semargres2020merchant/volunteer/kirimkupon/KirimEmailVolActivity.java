...
public class KirimEmailVolActivity extends AppCompatActivity implements MerchantAdapter.MerchantAdapterCallback {
    ...
    private void initUi(){
        ...
        id_merchant = sessionMerchant.getSpIdEmail();
...
//        initSpKategori();
    ...
    protected void onResume() {
        ...
        btnKirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendKupon();
//                Toast.makeText(KirimEmailVolActivity.this, cara_bayar, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void sendKupon(){
        ...
        if(tvMerchantEmail.getText().toString().equals("")){
            tvMerchantEmail.setError("Silahkan memilih merchant");
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(KirimEmailVolActivity.this)
                .setTitle("Konfirmasi")
    ...
    private void prepareSendKupon(){
        ...
        try {
            jBody.put("id_merchant",sessionMerchant.getSpIdEmail());
            jBody.put("via","email");
            jBody.put("kepada", edtEmail.getText());
            jBody.put("total", edtNominal.getText());
            jBody.put("id_cara_bayar", String.valueOf(cara_bayar));
        ...
        new ApiVolley(KirimEmailVolActivity.this, jBody, "POST", URL.urlKirimKuponViaSmsVolunter, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
...
//        initSpKategori();
    ...
    private void showProgressDialog() {
        progressDialog = new ProgressDialog(KirimEmailVolActivity.this,
