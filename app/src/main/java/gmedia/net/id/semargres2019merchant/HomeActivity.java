...
import gmedia.net.id.semargres2019merchant.historyPenjualan.HistoryPenjualanActivity;
import gmedia.net.id.semargres2019merchant.kategoriKupon.SettingKategoriKuponActivity;
import gmedia.net.id.semargres2019merchant.kategoriKupon.SettingKategoriKuponModel;
import gmedia.net.id.semargres2019merchant.kuis.KuisActivity;
import gmedia.net.id.semargres2019merchant.promo.CreatePromoActivity;
...
import gmedia.net.id.semargres2019merchant.util.RuntimePermissionsActivity;
import gmedia.net.id.semargres2019merchant.util.SessionManager;
import gmedia.net.id.semargres2019merchant.util.TwoItemModel;
import gmedia.net.id.semargres2019merchant.util.URL;
import gmedia.net.id.semargres2019merchant.voucher.VoucherActivity;
