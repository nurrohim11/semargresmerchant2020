package gmedia.net.id.semargres2019merchant.akun;
...
import gmedia.net.id.semargres2019merchant.util.CustomKategoriModel;
import gmedia.net.id.semargres2019merchant.util.GoogleLocationManager;
import gmedia.net.id.semargres2019merchant.util.HideKeyboard;
import gmedia.net.id.semargres2019merchant.util.ScrollableMapView;
import gmedia.net.id.semargres2019merchant.util.URL;

import static gmedia.net.id.semargres2019merchant.util.CompressBitmap.scaleDown;
