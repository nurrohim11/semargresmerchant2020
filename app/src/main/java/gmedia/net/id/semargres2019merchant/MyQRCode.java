...
import gmedia.net.id.semargres2019merchant.akun.ListAkunActivity;
import gmedia.net.id.semargres2019merchant.util.ApiVolley;
import gmedia.net.id.semargres2019merchant.util.Proses;
import gmedia.net.id.semargres2019merchant.util.SessionManager;
...
//                    downloadManager.enqueue(request);
        ...
        btnKirim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new ApiVolley(MyQRCode.this, new JSONObject(), "GET", gmedia.net.id.semargres2019merchant.util.URL.urlKirim + "/" + id, "", "", 0, new ApiVolley.VolleyCallback() {
                    @Override
    ...
    private void prepareDataBarcode() {
        proses.ShowDialog();
        new ApiVolley(context, new JSONObject(), "GET", gmedia.net.id.semargres2019merchant.util.URL.urlQrCodeTenant, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
    ...
    private void prepareNamaMerchant() {
        new ApiVolley(MyQRCode.this, new JSONObject(), "GET", gmedia.net.id.semargres2019merchant.util.URL.urlProfile, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject object = new JSONObject(result);
    ...
    private void prepareNamaTenant() {
        new ApiVolley(MyQRCode.this, new JSONObject(), "GET", gmedia.net.id.semargres2019merchant.util.URL.urlProfileTenant, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject object = new JSONObject(result);
