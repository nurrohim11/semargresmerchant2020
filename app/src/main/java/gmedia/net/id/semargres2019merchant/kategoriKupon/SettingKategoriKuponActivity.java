package gmedia.net.id.semargres2019merchant.kategoriKupon;
    ...
    private void getDataKupon() {
        ...
        new ApiVolley(this, new JSONObject(), "POST", URL.urlKategoriKupon, "", "", 0, new ApiVolley.VolleyCallback() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    JSONObject object = new JSONObject(result);
//                    Log.d("hasil kupon", object.toString());
                    String status = object.getJSONObject("metadata").getString("status");
...
//                                    if (i<kuponLama.size()) kuponBaru.add(kuponLama.get(i));
//                                }
//                                adapter.addMoreData();
//                            }
//                        };
